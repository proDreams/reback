...
- [Конфигурация](#конфигурация)
    ...
    - [Виды элементов и их параметры](#виды-элементов-и-их-параметры)
...
### Виды элементов и их параметры:

- `postgresql`: Бэкап базы данных PostgreSQL. Для этого типа укажите:
    - `db_host` (необязательно): Хост базы данных. По умолчанию `localhost`.
    - `db_port`: Порт для подключения.
    - `db_name`: Имя базы данных.
    - `db_user`: Пользователь базы данных.
    - `db_password`: Пароль пользователя.

- `postgresql_docker`: Бэкап базы данных PostgreSQL из Docker-контейнера. Для этого типа укажите:
    - `docker_container`: Имя контейнера Docker с PostgreSQL.
    - `db_name`: Имя базы данных.
    - `db_user`: Пользователь базы данных.
    - `db_password`: Пароль пользователя.

- `mongodb`: Бэкап базы данных MongoDB. Для этого типа укажите:
    - `db_host` (необязательно): Хост базы данных. По умолчанию `localhost`.
    - `db_port`: Порт для подключения.
    - `db_user` (необязательно): Пользователь базы данных.
    - `db_password` (необязательно): Пароль пользователя.

- `mongodb_docker`: Бэкап базы данных MongoDB из Docker-контейнера. Для этого типа укажите:
    - `docker_container`: Имя контейнера Docker с MongoDB.
    - `db_user` (необязательно): Пользователь базы данных.
    - `db_password` (необязательно): Пароль пользователя.

- `mysql`: Бэкап базы данных MySQL. Для этого типа укажите:
    - `db_host` (необязательно): Хост базы данных. По умолчанию `localhost`.
    - `db_port`: Порт для подключения.
    - `db_name`: Имя базы данных.
    - `db_user`: Пользователь базы данных.
...
- `mysql_docker`: Бэкап базы данных MySQL из Docker-контейнера. Для этого типа укажите:
    - `docker_container`: Имя контейнера Docker с MySQL.
    - `db_name`: Имя базы данных.
    - `db_user`: Пользователь базы данных.
    - `db_password`: Пароль пользователя.

- `folder`: Бэкап локальной директории. Для этого типа укажите:
    - `target_path`: Путь до директории, которую нужно забэкапить.

Каждый элемент также включает:
